...
import com.smk.business.netty.client.longConnection.NettyProxy;
...
@RestController
@Slf4j
@RequestMapping("/apiLong")
public class NettyApiLongConnectionController {
    ...
    public BaseResult test(String param) {
        XyExampleService xyExampleService = nettyProxy.create(XyExampleService.class);
